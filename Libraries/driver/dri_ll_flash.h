...
/* FLASH 基地址 */
#define DRI_LL_FLASH_BASE_ADDR 0x40022000UL // FLASH寄存器基地址

/* FLASH 寄存器偏移地址*/
#define DRI_LL_FLASH_ACR_OFFSET     0x00UL // 访问控制寄存器
#define DRI_LL_FLASH_KEYR_OFFSET    0x04UL // 密钥寄存器
#define DRI_LL_FLASH_OPTKEYR_OFFSET 0x08UL // 选项密钥寄存器
#define DRI_LL_FLASH_SR_OFFSET      0x0CUL // 状态寄存器
#define DRI_LL_FLASH_CR_OFFSET      0x10UL // 控制寄存器
#define DRI_LL_FLASH_AR_OFFSET      0x14UL // 地址寄存器
#define DRI_LL_FLASH_OBR_OFFSET     0x1CUL // 选项字节寄存器
#define DRI_LL_FLASH_WRPR_OFFSET    0x20UL // 写保护寄存器
